    ...
    private void countDeadStones() {
        ...
        for (int x = 0; x < size; x++) {
            for (int y = 0; y < size; y++) {
                ...
                if ( (intersections[x][y].stone == null && BLACK.equals(previousStone) ) || StoneColor.BLACKDEAD.equals(intersections[x][y].stone)){
                    whiteScore++;
                }
                if ((intersections[x][y].stone == null && WHITE.equals(previousStone) ) || StoneColor.WHITEDEAD.equals(intersections[x][y].stone)){
                    blackScore++;
                }
            }
        }
